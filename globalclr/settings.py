...
# SECURITY
SECRET_KEY = 'django-insecure-332+)!7sygy4bh5icu(%%!fi7wdn)skp0(4^4q1pbp^444gbl='
...
ALLOWED_HOSTS = [
    ...
    'global-md7b.onrender.com',  # Render URL (NO https)
    'globalcarrierinfo.in',      # your domain
    'www.globalcarrierinfo.in'   # your domain with www
]
...
WSGI_APPLICATION = 'globalclr.wsgi.application'
